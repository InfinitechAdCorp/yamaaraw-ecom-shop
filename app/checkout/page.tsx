...
export default function CheckoutPage() {
  ...
  const handleInputChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (name === "phone") {
      ...
      // Only allow letters, spaces, and common location characters (hyphens, apostrophes)
      const lettersOnly = value.replace(/[^a-zA-Z\s'-]/g, "")
      setShippingInfo({
        ...shippingInfo,
        [name]: lettersOnly,
  ...
  const validateForm = () => {
    ...
    // Check if phone starts with 09 (common PH mobile format)
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-gradient-to-br from-slate-900 via-orange-900 to-red-900 text-white py-8 sm:py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-2">Checkout</h1>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input
                        ...
                        readOnly
                        className="h-12 sm:h-12 bg-gray-50 cursor-not-allowed"
                        placeholder="First name from your account"
                      />
                      <p className="text-xs text-gray-500 mt-1">First name is automatically filled from your account</p>
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-1">
                      ...
                      <Input
                        ...
                        readOnly
                        className="h-12 sm:h-12 bg-gray-50 cursor-not-allowed"
                        placeholder="Last name from your account"
                      />
                      <p className="text-xs text-gray-500 mt-1">Last name is automatically filled from your account</p>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        readOnly
                        className="pl-10 h-12 sm:h-12 bg-gray-50 cursor-not-allowed"
